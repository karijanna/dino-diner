...
namespace MenuTest.Entrees
{
    public class TRexKingBurgerUnitTest
    {
        ...
        [Fact]
        public void HoldLettuceShouldNotifyChangesOfSpecialPropertyChange()
        {
            TRexKingBurger trex = new TRexKingBurger();
            Assert.PropertyChanged(trex, "Special", () =>
            {
        ...
        [Fact]
        public void HoldTomatoShouldNotifyChangesOfSpecialPropertyChange()
        {
            TRexKingBurger trex = new TRexKingBurger();
            Assert.PropertyChanged(trex, "Special", () =>
            {
        ...
        [Fact]
        public void HoldOnionsShouldNotifyChangesOfSpecialPropertyChange()
        {
            TRexKingBurger trex = new TRexKingBurger();
            Assert.PropertyChanged(trex, "Special", () =>
            {
        ...
        [Fact]
        public void HoldKetchupShouldNotifyChangesOfSpecialPropertyChange()
        {
            TRexKingBurger trex = new TRexKingBurger();
            Assert.PropertyChanged(trex, "Special", () =>
            {
        ...
        [Fact]
        public void HoldMayoShouldNotifyChangesOfSpecialPropertyChange()
        {
            TRexKingBurger trex = new TRexKingBurger();
            Assert.PropertyChanged(trex, "Special", () =>
            {
